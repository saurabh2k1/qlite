<?php include_once 'header.php';
    ...
    if(!isset($_GET['s']) || empty($_GET['s'])) {
        ...
        $new = true;
        $db->where('siteid', $site['siteid'])->where('enrolled > 0');
...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
    ...
    <?php } ?>
    <?php if (!$new) { ?>
    <form action="saveUnsch.php" method="post" class="validate" novalidate>
    ...
    <?php 
        $db->where('subid', $subject['id']);
        $visits = $db->get('ped_unschedule');
        if ($visits) {
    ?>
    <div class="row">
        <div class="col col-md-10">
            <table class="table table-bordered">
                <thead>
                    <tr><th>Earlier Un-scheduled Visits by Subject  </th></tr>
                </thead>
                <tbody>
                    <?php foreach ($visits as $visit) { ?>
                    <tr>
                        <td><?php echo date('d-M-Y', strtotime($visit['dov'])); ?></td>
                    </tr>
                    <?php } ?>
    ...
    <hr>
    <div class="row">
        <div class="col col-md-4">Date of Visit</div>
        <div class="col col-md-4"><input type="text" value="<?php echo date('Y-m-d'); ?>" id="dov" name="dov" data-template="DD MMM YYYY" data-format="YYYY-MM-DD" ></div> 
    </div><!-- /row -->
    <hr>
    <div class="row">
        <div class="col col-md-12">
            <table class="table table-bordered">
                <tr class="thead-dark">
                    <th colspan="2">DIARRHEA HISTORY </th>
                </tr>
                <tr>
                    <td>Number of episodes of loose, semi-liquid or liquid stools<br> 
                        <span class="text-danger">Since last visit as reported by parent in SDDC</span></td>
                    <td>
                        <div class="row">
                            <div class="col">Loose stools</div>
                            <div class="col"><input class="count" type="number" min="0" id="looseCount" name="looseCount"></div>
                        </div>
                        <div class="row">
                            <div class="col">Semi-liquid stools</div>
                            <div class="col"><input class="count" type="number" min="0" id="semiCount" name="semiCount"></div>
                        </div>
                        <div class="row">
                            <div class="col">Liquid Stools</div>
                            <div class="col"><input class="count" type="number" min="0" id="liquidCount" name="liquidCount"></div>
                        </div>
                        <div class="row">
                            <div class="col">Total</div>
                            <div class="col"><input readonly  type="number" id="totalCount" min="0" name="totalCount"></div>
                        </div>
                    </td>
                </tr>
                <tr><td>When was the last loose, semi-liquid or liquid stools <span class="text-danger">reported by parent in SDDC</span></td>
                    <td><input type="text" id="lastLoose" name="lastLoose" data-template="DD MMM YYYY" data-format="YYYY-MM-DD" ></td>
                </tr>
                <tr>
                    <td>Level of dehydration</td>
                    <td>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="dehydrationLevel" id="dehydrationLevel1" value="No Dehydration">
                        <label class="form-check-label" for="dehydrationLevel1">No Dehydration</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="dehydrationLevel" id="dehydrationLevel2" value="Some Dehydration">
                        <label class="form-check-label" for="dehydrationLevel2">Some Dehydration</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="dehydrationLevel" id="dehydrationLevel3" value="Severe Dehydration">
                        <label class="form-check-label" for="dehydrationLevel3">Severe Dehydration</label>
                    </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="isBloodStool" id="isBloodStool1" value="Y">
                            <label class="form-check-label" for="isBloodStool1">Yes</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="isBloodStool" id="isBloodStool2" value="N">
                            <label class="form-check-label" for="isBloodStool2">No</label>
                        </div>
                    </td>
                </tr>
            </table>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <td><input type="number" id="kit_no" name="kit_no" min="0" placeholder="Enter Number"> </td></tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <div id="kitUsedYes" style="display:none;">Total number collected <input type="number" min="0" id="usedKitNo" name="usedKitNo"></div>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div id="kitUnUsedNo" style="display:none;">If No, Then Why <input type="text" id="reasonNoUsedKit" name="reasonNoUsedKit" placeholder="If No, Then Why"></div>
                        </td>
                    </tr>
                </tbody>
                <tfoot>
...
$(function () {
    ...
    $("#btnGo").on('click', function(e){
        ...
        window.location = 'unscheduled.php?s='+sid;
    });

    $(".count").on('change', function(e){
        var loose = $("#looseCount").val();
        var semi = $("#semiCount").val();
        var liquid = $("#liquidCount").val();
        var total = parseInt(loose) + parseInt(semi) + parseInt(liquid);
