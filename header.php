                ...
                <div class="dropdown-menu" aria-labelledby="smallerscreenmenu">
                    ...
                    if ($study) {
                        ...
                        foreach ($forms as $form) { ?>
                            <a class="dropdown-item" href="forms/<?php echo $form['filename']; ?>">
                ...
                <?php if (!empty($_SESSION['studyid'])) { 
                    ...
                    <div id="studySubmenu" class="collapse sidebar-submenu">
                        ...
                        <?php 
                            ...
                            foreach($forms as $form) {
                        ?>
                            <a class="list-group-item list-group-item-action bg-dark text-white" href="forms/<?php echo $form['filename']; ?>">
